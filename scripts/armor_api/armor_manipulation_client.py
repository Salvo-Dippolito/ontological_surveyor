...
class ArmorManipulationClient(object):
    ...
    # def disjoin_inds_in_class(self, class_name):
    ...
    #     except rospy.ServiceException as e:
    #         raise ArmorServiceCallError(
    #             "Service call failed disjoining individuals in class {0}: {1}".format(class_name,e))
    ...
    def disjoin_all_inds(self,individuals_list):
